...
macro_rules! operation_definitions {
    ($consumer:ident) => {
        $consumer! {
            ...
            DATA_MAPPING_LIST => DataMappingList, "data.mapping.list", AccessPolicy::Authenticated, ExecutionMode::Standard, HandlerKind::App, TransportKind::Message, ConnectionKind::Shared, DataMappingListInput;
            DATA_MAPPING_UPDATE => DataMappingUpdate, "data.mapping.update", AccessPolicy::Authenticated, ExecutionMode::Standard, HandlerKind::App, TransportKind::Message, ConnectionKind::Shared, DataMappingUpdateInput;
            DATA_MAPPING_DELETE => DataMappingDelete, "data.mapping.delete", AccessPolicy::Authenticated, ExecutionMode::Standard, HandlerKind::App, TransportKind::Message, ConnectionKind::Shared, DataMappingDeleteInput;
