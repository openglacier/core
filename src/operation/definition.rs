...
macro_rules! operation_definitions {
    ($consumer:ident) => {
        $consumer! {
            ...
            CORE_DISCOVER => CoreDiscover, "core.discover", AccessPolicy::Public, ExecutionMode::Standard, HandlerKind::Core, TransportKind::Message, ConnectionKind::Shared, EmptyInput;
            ...
            QUERY_CONTEXT_RESOLVE => QueryContextResolve, "query.context.resolve", AccessPolicy::Public, ExecutionMode::Standard, HandlerKind::App, TransportKind::Message, ConnectionKind::Shared, QueryContextResolveInput;
            ...
            PLACE_RESOURCE_LIST => PlaceResourceList, "place.resource.list", AccessPolicy::Public, ExecutionMode::Standard, HandlerKind::Place, TransportKind::Message, ConnectionKind::Shared, PlaceIdInput;
            ...
            APP_LIST => AppList, "app.list", AccessPolicy::Public, ExecutionMode::Standard, HandlerKind::App, TransportKind::Message, ConnectionKind::Shared, UncheckedInput;
            APP_GET => AppGet, "app.get", AccessPolicy::Public, ExecutionMode::Standard, HandlerKind::App, TransportKind::Message, ConnectionKind::Shared, AppIdInput;
            ...
            APP_INSTANCE_LIST => AppInstanceList, "app.instance.list", AccessPolicy::Public, ExecutionMode::Standard, HandlerKind::App, TransportKind::Message, ConnectionKind::Shared, PlaceIdInput;
            ...
            DATA_ANALYZE => DataAnalyze, "data.analyze", AccessPolicy::Public, ExecutionMode::Standard, HandlerKind::App, TransportKind::Message, ConnectionKind::Shared, DataAnalyzeInput;
            DATA_IMPORT => DataImport, "data.import", AccessPolicy::Public, ExecutionMode::Standard, HandlerKind::App, TransportKind::Message, ConnectionKind::Shared, DataImportInput;
            ...
            DATA_MAPPING_SAVE => DataMappingSave, "data.mapping.save", AccessPolicy::Public, ExecutionMode::Standard, HandlerKind::App, TransportKind::Message, ConnectionKind::Shared, DataMappingSaveInput;
            DATA_MAPPING_LIST => DataMappingList, "data.mapping.list", AccessPolicy::Public, ExecutionMode::Standard, HandlerKind::App, TransportKind::Message, ConnectionKind::Shared, DataMappingListInput;
            DATA_MAPPING_UPDATE => DataMappingUpdate, "data.mapping.update", AccessPolicy::Public, ExecutionMode::Standard, HandlerKind::App, TransportKind::Message, ConnectionKind::Shared, DataMappingUpdateInput;
            DATA_MAPPING_DELETE => DataMappingDelete, "data.mapping.delete", AccessPolicy::Public, ExecutionMode::Standard, HandlerKind::App, TransportKind::Message, ConnectionKind::Shared, DataMappingDeleteInput;
            FILE_CAPABILITIES => FileCapabilities, "file.capabilities", AccessPolicy::Public, ExecutionMode::File, HandlerKind::File, TransportKind::Message, ConnectionKind::Shared, FileScopeInput;
            ...
            FILE_LIST => FileList, "file.list", AccessPolicy::Public, ExecutionMode::File, HandlerKind::File, TransportKind::Message, ConnectionKind::Shared, FileListInput;
            FILE_STAT => FileStat, "file.stat", AccessPolicy::Public, ExecutionMode::File, HandlerKind::File, TransportKind::Message, ConnectionKind::Shared, FileEntryInput;
            FILE_MKDIR => FileMkdir, "file.mkdir", AccessPolicy::Public, ExecutionMode::File, HandlerKind::File, TransportKind::Message, ConnectionKind::Shared, FileMkdirInput;
            FILE_MOVE => FileMove, "file.move", AccessPolicy::Public, ExecutionMode::File, HandlerKind::File, TransportKind::Message, ConnectionKind::Shared, FileMoveInput;
            FILE_COPY => FileCopy, "file.copy", AccessPolicy::Public, ExecutionMode::File, HandlerKind::File, TransportKind::Message, ConnectionKind::Shared, FileMoveInput;
            FILE_DELETE => FileDelete, "file.delete", AccessPolicy::Public, ExecutionMode::File, HandlerKind::File, TransportKind::Message, ConnectionKind::Shared, FileEntryInput;
            FILE_TRASH_LIST => FileTrashList, "file.trash.list", AccessPolicy::Public, ExecutionMode::File, HandlerKind::File, TransportKind::Message, ConnectionKind::Shared, FileScopeInput;
            FILE_RESTORE => FileRestore, "file.restore", AccessPolicy::Public, ExecutionMode::File, HandlerKind::File, TransportKind::Message, ConnectionKind::Shared, FileEntryInput;
            FILE_DELETE_PERMANENT => FileDeletePermanent, "file.delete.permanent", AccessPolicy::Public, ExecutionMode::File, HandlerKind::File, TransportKind::Message, ConnectionKind::Shared, FileEntryInput;
            FILE_TRASH_EMPTY => FileTrashEmpty, "file.trash.empty", AccessPolicy::Public, ExecutionMode::File, HandlerKind::File, TransportKind::Message, ConnectionKind::Shared, FileScopeInput;
            FILE_READ => FileRead, "file.read", AccessPolicy::Public, ExecutionMode::File, HandlerKind::File, TransportKind::BinaryOut, ConnectionKind::Exclusive, FileReadInput;
            FILE_WRITE => FileWrite, "file.write", AccessPolicy::Public, ExecutionMode::File, HandlerKind::File, TransportKind::BinaryIn, ConnectionKind::Exclusive, FileWriteInput;
            FILE_VERSIONS => FileVersions, "file.versions", AccessPolicy::Public, ExecutionMode::File, HandlerKind::File, TransportKind::Message, ConnectionKind::Shared, FileEntryInput;
            FILE_VERSION_READ => FileVersionRead, "file.version.read", AccessPolicy::Public, ExecutionMode::File, HandlerKind::File, TransportKind::BinaryOut, ConnectionKind::Exclusive, FileVersionReadInput;
            FILE_VERSION_RESTORE => FileVersionRestore, "file.version.restore", AccessPolicy::Public, ExecutionMode::File, HandlerKind::File, TransportKind::Message, ConnectionKind::Shared, FileVersionInput;
            FILE_VERSION_DELETE => FileVersionDelete, "file.version.delete", AccessPolicy::Public, ExecutionMode::File, HandlerKind::File, TransportKind::Message, ConnectionKind::Shared, FileVersionInput;
            COLLECTIONS_LIST => CollectionsList, "collections.list", AccessPolicy::DynamicPermission(AuthorizationAction::CollectionsList), ExecutionMode::Standard, HandlerKind::Collections, TransportKind::Message, ConnectionKind::Shared, CollectionsListInput;
